...
public:
    MoveAction()
        : plansys2::ActionExecutorClient("joint_move", 250ms)
    {
        joint_names = {
        ...
        // - -0.422887809488517
        // - 0.32360963089329653
        point.positions[0] = -0.235;
        point.positions[1] = -1.065;
        point.positions[2] = -0.486;
        point.positions[3] = 0.524;
        point.positions[4] = 0.082;
        point.positions[5] = -0.422;
        point.positions[6] = 0.323;
...
int main(int argc, char ** argv)
{
    ...
    node->set_parameter(rclcpp::Parameter("action_name", "joint_move"));
